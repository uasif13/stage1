...
;}
  ...
  case 40:
    ...
    {
                    igraph_integer_t from = (yyvsp[(1) - (4)].integer), to = (yyvsp[(2) - (4)].integer);
  ...
  case 41:
    ...
    {
                    igraph_integer_t from = (yyvsp[(1) - (3)].integer), to = (yyvsp[(2) - (3)].integer);
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(from));
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(to));
...
;}
  ...
  case 60:
    ...
    {
  igraph_integer_t to = (yyvsp[(2) - (2)].integer);
  IGRAPH_YY_CHECK(igraph_i_dl_check_vid(to));
  IGRAPH_YY_CHECK(igraph_vector_int_push_back(&context->edges,
                                              context->from-1));
