 ...
 *
 */
static igraph_error_t igraph_i_community_leiden_fastmovenodes_directed(
    ...
    // membership = which cluster to put node
    // cluster_weights = node+_weights
    // num of nodes in clusters = initially all 1s
    while (!igraph_dqueue_int_empty(&unstable_nodes)) {
        ...
        // printf("my_rank: %d node: %d best_cluster: %d current_cluster: %d\n", my_rank, v, best_cluster, current_cluster);
        ...
        // printf("my_rank: %d [[igraph_i_community_leiden_fastmovenodes_directed] empty clusters: \n",my_rank);
        ...
        nb_neigh_clusters = 1;
        // printf("my_rank: %d [[igraph_i_community_leiden_fastmovenodes_directed] nb_clusters: \n", my_rank);
        ...
        // printf("my_rank: %d [igraph_i_community_leiden_fastmovenodes_directed] edges: \n");
        // igraph_vector_int_print(edges);
        // printf("my_rank: %d [igraph_i_community_leiden_fastmovenodes_directed] edge weights per cluster: \n");
        ...
        printf("my_rank: %d [igraph_i_community_leiden_fastmovenodes_directed] node: %d best_cluster: %d \n", my_rank, v, best_cluster);
        ...
        // printf("my_rank: %d [igraph_i_community_leiden_fastmovenodes_directed] end of iteration of while loop membership: \n", my_rank);
        // igraph_vector_int_print(&membership);

    }

    IGRAPH_CHECK(igraph_reindex_membership(&membership, NULL, nb_clusters));
    printf("my_rank: %d [igraph_i_community_leiden_fastmovenodes_directed] end of function: \n", my_rank);
    igraph_vector_int_print(&membership);
 ...
 * is empty.
 */
static igraph_error_t igraph_i_community_get_clusters(const igraph_vector_int_t *gc_membership, igraph_vector_int_list_t *clusters) {
    igraph_integer_t n = igraph_vector_int_size(gc_membership);
    igraph_vector_int_t *cluster;

    for (igraph_integer_t i = 0; i < n; i++) {
        /* Get cluster for node i */
        cluster = igraph_vector_int_list_get_ptr(clusters, VECTOR(*gc_membership)[i]);
...
static igraph_error_t igraph_i_community_leiden_directed(
    ...
    *changed = false;
    ...
    do {
        ...
        // printf("my_rank: %d [igraph_i_community_leiden_directed] edges_per_node: \n");
        // igraph_inclist_print(&edges_per_node);
        // edges_per_node = edge labels

        /* Move around the nodes in order to increase the quality */
        IGRAPH_CHECK(igraph_i_community_leiden_fastmovenodes_directed(i_graph,
                     &edges_per_node,
        ...
        printf("my_rank: %d [igraph_i_community_leiden_directed] after fastmove membership: \n", my_rank);
        igraph_vector_int_print(&membership);
...
igraph_error_t igraph_community_leiden_directed(const igraph_t *graph,
                            ...
                            igraph_integer_t *nb_clusters, igraph_real_t *quality, int my_rank, int my_work) {
    igraph_vector_t *i_edge_weights, *i_node_weights;
    igraph_integer_t i_nb_clusters;
    igraph_integer_t n = igraph_vcount(graph);
    printf("my_rank: %d [igraph_community_leiden_directed] start\n", my_rank);
    ...
    if (start) {
        ...
        if (igraph_vector_int_size(&membership) != my_work) {
    ...
    printf("my_rank: %d [igraph_community_leiden_directed] enter for loop\n", my_rank);
    ...
    for (igraph_integer_t itr = 0;
        ...
        IGRAPH_CHECK(igraph_i_community_leiden_directed(graph, i_edge_weights, i_node_weights,
                                               resolution_parameter, beta,
                                               nb_clusters, quality, &changed, my_rank, my_work));
    }
